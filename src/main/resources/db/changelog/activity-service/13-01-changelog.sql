...
insert into activity_tag (activity_id, tag_id) VALUES (4, 1);

-- changeSet romzes:activity_data_03 contexts:romzes
insert into activity_scheduled (status, activity_id, date_time) VALUES ('STARTED', 4, '2021-11-11 11:40');
...
insert into activity_scheduled (status, activity_id, date_time) VALUES ('STARTED', 8, '2021-11-11 12:40');
-- changeSet romzes:activity_data_06 contexts:romzes
insert into activity_scheduled (status, activity_id, date_time) VALUES ('STARTED', 8, '2022-11-11 12:40');